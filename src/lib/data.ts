...
import type { DataEnvelope, RegistrationFact, ScoreBoundaryFact, ScoreDistributionFact, SourceRecord, StandardFact } from "./types";
...
export async function getAllData() {
  const [registration, distributions, boundaries, standards, sources, quality] = await Promise.all([
